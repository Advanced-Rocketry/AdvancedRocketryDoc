<?php
    ...
    <p>The final piece in managing your data is the <a href="../blocks/ABDP.php">Astrobody Data Processor</a> or ABDP. The purpose of this machine is to process all incoming data into asteroid ID chips for more efficient and richer mining excursions. Data will need to be either inserted manually by way of data chips or via <a href="../blocks/WirelessTransciever.php">Wireless Transcievers</a>. To make effecient use of these, you will need 6, two for each data type. 1 attached to a data bus on the ABDP the other attached to a Satellite Terminal connected to a satellite of the cooresponding data type. This is a 1:1 mechanic.</p>
    <p>Once you have collected a decent amoung of all three data types, they can be downloaded into an asteroid id chip by using the research buttons associated with the data type you wish to download. the benefits of including more data in the asteroid chip is explained below.
