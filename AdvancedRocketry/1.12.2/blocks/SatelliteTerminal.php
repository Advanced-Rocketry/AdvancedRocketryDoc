<?php
    ...
    */    
    ...
    <p><h3>Satellite Management</h3>The inventory in the top right holds a programmed satellite ID chip containing the information of the satellite to connect to.  When connected it is possible to download data and view the satellite\'s properties.</p>
