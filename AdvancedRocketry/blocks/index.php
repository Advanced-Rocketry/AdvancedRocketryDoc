...
<p>Information about blocks can be found in the following list:</p>
<ul>
...
<li><img class="icon" src="../img/energyCable_icon.png"> <a href="Cables.php">Cables and Pipes</a></li>
...
<li><img class="icon" src="../img/seal_icon.png"> <a href="Seal.php">Seal</a></li>
...
<li><img class="icon" src="../img/solarGenerator_icon.png"> <a href="SpaceElevator.php">Space Elevator</a></li>
<li><img class="icon" src="../img/stationDockingPort_icon.png"> <a href="StationDockingPort.php">Station Docking Port</a></li>
