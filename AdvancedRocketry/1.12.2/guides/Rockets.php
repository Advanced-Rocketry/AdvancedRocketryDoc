<?php
    ...
    <p>A rocket can be built from any block in the game but must contain a number of <a href="../blocks/RocketEngine.php">Engines</a> and <a href="../blocks/FuelTank.php">Fuel Tanks</a>. Engines provide thrust, and the number of engines needed is based on the mass. They also consume fuel, which is stored in the fuel tanks. There must be enough fuel tanks to hold the amount of fuel needed for any mission. Other blocks can be added to increase functionality, see below.</p><p>When you have finished building your rocket, you will need to use the <a href="../blocks/RocketAssemblingMachine.php">rocket assembling machine</a> to verify and build it. Scanning a build determines if you have the right number of engines and fuel tank to make a successful trip. Once you have verified a successful build, the rocket can be built. The rocket is not a rocket until it is built, otherwise its just a collection of blocks. Once a rocket is built, you can interact with it.
    <a id="interaction"></a>
    <hr>
    <center><h2>Interaction</h2></center>
    <img width=40% align="left" src="../img/rocket_gui.png" />
    ...
    <p>There are three major uses for rockets in Advanced Rocketry: Player Transport, Cargo Transport, and Satellite/Space Station launches. There are also a number of blocks, referred to as Infrastructures, which interact with the rockets and aid in their use. To understand how to use a rocket, you must understand how these Infrastructures work.</p>
    <h4>Infrastructures</h4>
    <p>Let\'s look at how to fuel/refuel the rocket to best understand how these Infrastructures work. The <a href="../items/linker.php">linker</a> is your best friend. It connects the rocket to the various infrastructures. Later, you can expand this idea and connect the infrastructures to a <a href="../blocks/LandingPad.php">docking pad</a> and any rocket using the docking pad will be linked to the infrastructures as well. More on this in <a href="../guides/BuildingSpaceStation.php">Intergalactic Travel.</a></p><p>To fuel a rocket you can either bucket the rocket fuel in. A better alternative, is to use a <a href="../blocks/FuellingStation.php">Fueling Station</a>. Once you have the fueling stations set-up and filled with rocket fuel, shift-right-click the fuelling station with the Linker, then shift-right-click a rocket. If the linked is done successfully, a dotted white line should appear from the fuelling station to the rocket, and the rocket will begin filling with fuel. As long as that rocket remains built, it will remain connected to linked infrastructure, and in this case, will re-fuel itself upon landing if there is fuel available in the fuelling station.</p>
    ...
    <p>The rocket is fueled and now we need to launch it. This requires a <a href="../blocks/RocketMonitoringStation.php">Rocket Monitoring Station</a>, an infrastructure which not only launches a linked rocket but also tracks its flight and <a href="../guides/Missions.php">mission</a> progress. The truly awesome thing about these machines is there range is unlimited. So you can build a nice look-out with an incredible view of your launch pad and watch your rocket blast off into space!! (need pictures).</p>
    <a id="usage"></a>
    <hr>
    ...
    <li>Include a <a href="../blocks/GuidanceComputer.php">guidance computer</a> and a <a href="../blocks/Seat.php">seat</a>.</li>
    <li>Fuel the Rocket</li>
    <li>Put on oxygen-filled <a href="../items/modularSpaceSuit.php">Spacesuit</a></li>
