<?php
    ...
    <p>The most common use of the linker is to link <a href="../blocks/hatches.php">hatches</a> to Rockets, Docking Pads, and <a href="../blocks/RocketAssemblingMachine.php">Rocket Assembling Machines</a>.</p>
