<?php
    ...
    <p>What good is a space program without some fancy platforms for building and launching Rockets? Advanced Rocketry provides launch pads for this purpose. The launch pad is where you will assemble, load/unload and launch your rockets. See the <a href="/AdvancedRocketry/1.12.2/blocks/LaunchPad.php" >launch pads</a> page for specifications on how to build the launch pad.</p>
    ...
    <p>Rockets are the only way to launch <a href="/AdvancedRocketry/1.12.2/items/satellite.php">satellites</a> and <a href="/AdvancedRocketry/1.12.2/blocks/StationBuilder.php">space station modules</a>space station modules. To launch a space station module or satellite the rocket requires only a <a href="/AdvancedRocketry/1.12.2/blocks/SatelliteHatch.php">satellite bay</a> containing the payload. Multiple payloads can be launched on a single rocket.</p>
    <a id="moon"></a>
    <hr>
