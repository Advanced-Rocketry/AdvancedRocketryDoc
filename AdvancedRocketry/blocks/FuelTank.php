<?php
    ...
    $mainContent = '<h1>'.$title.'</h1><hr><img align="left" src="../img/fuelTank_demo.jpg" /><center><h2>Overview</h2></center><p>&nbsp;&nbsp;&nbsp;&nbsp;Fuel Tanks are cylindrical 
    ...
    $infoBarContent = $title.'<hr><img src="../img/fuelTank_block.png" /><hr>Hardness: 2<br />Blast Resistance: 0<br />Requires Tool: Yes<br />Full Block: No<br />Sealable: No<br />Tile Entity: Yes<hr><center>Teir 1</center><br />Fuel Storage: 500mb';
