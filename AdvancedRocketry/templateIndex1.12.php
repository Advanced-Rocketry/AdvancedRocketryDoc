...
<div class="container-fluid">
  ...
  <nav class="navbar navbar-expand-md m-0 p-0 version" id="navigation">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
      <ul class="navbar-nav">
        ...
        <li class="nav-item"><a class="nav-link active" href="/AdvancedRocketry/1.12.2/config/index.html">Configuration<br/>
  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-2 col-md-3 col-sm-4 col-xs-4 m-0 p-0">
        <div class="mr-2 sidebar">
          <img style="width: 100%;" alt="Advanced Rocketry Logo" src="/AdvancedRocketry/logo.png" /><hr /><?php echo $infoBarContent; ?>
        </div>
      </div>
