<?php
    ...
    */    
    ...
    <p>By default, the Oxygen Vent can only fill a square radius of 32 blocks.  However if the <italic>atmosphereCalculationMethod</italic> is set to use volume based calculations, the Oxygen Vent can fill up to 32,768 cubic blocks.</p>';
