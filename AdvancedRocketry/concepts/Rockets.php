<?php
    ...
    <p>Rockets can also be used to transport cargo between bodies in a planet moon system.  To be used for cargo, a rocket must be have some number of chests or fluid tanks and a <a href="../blocks/GuidanceComputer.php">guidance computer</a>.  A static shipping route can be set up by linking two <a href="../blocks/DockingPad.php">docking pads</a> together with <a href="../items/linker.php">linkers</a>.</p>
    ...
    <p>There are various different infrastructures that can interact with rockets to perform a vareity of useful tasks.  infrastructure can be connected directly to a rocket, <a href="../blocks/RocketAssemblingMachine.php">rocket assembling machine</a>, <a href="../blocks/UnmannedVehicleAssembler.php">unmanned vehicle assembler</a>, or a <a href="../blocks/DockingPad.php">docking pad</a> using the <a href="../items/linker.php">linker</a>.</p>
