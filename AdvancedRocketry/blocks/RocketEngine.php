<?php
    ...
    $mainContent = '<h1>'.$title.'</h1><hr><img align="left" src="/AdvancedRocketry/img/rocketEngine_demo.jpg" /><p>&nbsp;&nbsp;&nbsp;&nbsp; The Rocket Engine
    ...
    $infoBarContent = $title.'<hr><img src="/AdvancedRocketry/img/rocketEngine_block.png" /><hr>Hardness: 2<br />Blast Resistance: 0<br />Requires Tool: Yes<br />Full Block: No<br />Sealable: No<br />Tile Entity: Yes<hr><center>Teir 1</center><br />Fuel Consumption: 1 mb/s<br />Thrust: 10 N';
