<?php
    ...
    <p>The primary usage of coils is in the electric arc furnace.  Using higher teir coils in some machines can decrease the amount of time required for a recipe.  Like the motors, the speed increases stack multiplicitivly.</p>';
