<?php
    ...
    */    
    ...
    $description1 = '<p>Motors are used in the construction of multiblock machines throughout the mod.  Motors also come in several teirs, higher teir motors being more powerful, but more expensive to make.
    </p>
    ...
    <p>
    One exception that exists is the <a href="Observatory.php">observatory</a>.  Rather than increasing the speed of the observatory, higher teir motors increase the observatory\'s obervable distance.</p>';
