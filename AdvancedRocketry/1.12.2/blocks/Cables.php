<?php
    ...
    */    
    ...
    <h3>Not a Logistics mod</h3>
    <p>The second issue is that Advanced Rocketry, despite having a number of machines, is not really a logistics or machine mod, advanced rocketry\'s primary focus is space travel.  there are many other mods out there dedicated to handling fluid flow and item flow.  Because I\'m one guy trying to balance a job, life, a Minecraft mod, and a game engine to host future projects ( think advanced rocketry with actually round planets and being able to actually fly in space without loading screens ), I don\'t have time to focus on an "everything" mod.</p>
    <p>Since I know no other mods handle data, the <a href="WirelessTransciever.php">Wireless Transceiver</a> was added to prevent loss of functionality.  While it is true the same can be done for fluids and items, I feel like that\'d go against the quasi-realistic, semi-near-term future that AR is meant to represent.</p>
    <h3>In Conclusion</h3>
    <p><bold>TL;DR:</bold> The pipes were buggy, meant to fix the lack of logistics mods when 1.10 came out, and would be very time consuming for me to fix, and I have very limited time.  I think it better to have something that works all the time and is more limited, than something that works some of the time but has more options.</p>
