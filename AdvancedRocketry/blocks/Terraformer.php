<?php
    ...
    <p>The Terraformer requires 10 mb/t of nitrogen and oxygen and 1000RF/t for the duration of the terraforming process.</p>
    <p>The Terraformer takes about an 15 minutes (configurable) to raise/lower the atmosphere by 0.01%</p>
    <br>
    <p>Each 0.01% increase/decrease in atmosphere requires 2,880 buckets of Oxygen and Nitrogen as well as 18 Million RF</p>
    ...
    $infoBarContent = $title.'<hr><img src="../img/electrolyser_block.png" /><hr>Hardness: 3<br />Blast Resistance: 0<br />Requires Tool: Yes<br />Full Block: Yes<br />Sealable: Yes<br />Tile Entity: Yes<br />Nitrogen: 160 mb/s<br />Oxygen: 160 mb/s<br />Energy: 1000RF/t';
