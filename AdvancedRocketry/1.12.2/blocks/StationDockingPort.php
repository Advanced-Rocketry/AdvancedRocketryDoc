<?php
    ...
    */    
    ...
    <p>Upon reaching orbit, the module should dock with the other module on the space station, in the process, both docking modules will be destroyed.</p>
    <p>It is important to remember that the station and the module with join in such a way that the clamp sides of both modules will face each other!</p></p>';
