<?php
    ...
    */    
    ...
    $description1 = '<p>The Station Builder is constructed in the same way as the <a href="RocketAssemblingMachine.php">Rocket Assembling Machine</a>.  However, rather that build rockets, the Station Builder builds space station modules from the blocks placed on the pad.</p>
    <p>These modules can then be loaded onto a rocket and launched into orbit.</p><br><br><br>';
    
    //FILL IN THIS PART IF THE BLOCK HAS A GUI
    $imageGUI = 'stationBuilder_gui.png';
    $descriptionGUI ='<p>Like the <a href="RocketAssemblingMachine.php">Rocket Assembling Machine</a>, the Station Builder\'s scan and build buttons scan and build the structure respectivly.</p>
