<?php
    ...
    <p>To use the Biome Changer Remote it must first be linked to a Biome Changing Satellite and the Satellite must be in orbit around the planet the Biome Changer Remote is to be used on by using the Biome Changer Remote in the ID Chip slot during the construction of a satellite in the <a href="../blocks/SatelliteAssemblingMachine.php">Satellite Assembling Machine</a>.</p>
